	  ...
	  _createClass(App, [{
	    ...
	    value: function handleClick() {
	      ...
	      $.get('/api').done(function (data) {
	        return _this2.setState({ works: data.works });
	      });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_works2.default, { works: this.state.works, name: this.state.name })
	      );
	    }
	  }]);
	  ...
	  _createClass(Works, [{
	    ...
	    value: function render() {
	      ...
	      var showTitle = function showTitle() {
	        return _this2.props.works.length ? _react2.default.createElement(
	          'h2',
	          null,
	          'Works'
	        ) : '';
	      ...
	      return _react2.default.createElement(
	        ...
	        null,
	        showTitle(),
	        this.props.works.map(function (work, i) {
	          return _react2.default.createElement(_work2.default, _extends({ key: i }, work));
	        })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Work = function (_React$Component) {
	  ...
	  _createClass(Work, [{
	    key: 'render',
	    value: function render() {
	      var parseRating = function parseRating(rating) {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('div', { className: 'summary', dangerouslySetInnerHTML: { __html: this.props.summary } })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".work ~ .work {\n  margin-top: 50px;\n}\n.work {\n  color: #333;\n}\n.work h3 {\n  margin: 0;\n  font-weight: normal;\n}\n.work h3 a {\n  color: #F44336;\n}\n.work .info,\n.work .author {\n  font-weight: lighter;\n  font-style: italic;\n}\n.work .info {\n  text-transform: lowercase;\n}\n", ""]);
